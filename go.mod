module github.com/jimyag/logpilot

go 1.26.0

require (
	github.com/jimyag/auto-cert-webhook v1.2.5
...
require (
	...
	github.com/openshift/library-go v0.0.0-20260204080437-623f3f25ebcb // indirect
